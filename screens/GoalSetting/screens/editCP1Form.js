...
export default function CreateCP1Form({ navigation, route }) {
  ...
  const {GoalDateTimeFormatted, Daily, Weekly, Monthly, Misc, DateTimeFormatted, Identifier} = route.params;
  ...
  return (
    <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
      <View style={globalStyles.container}>
        ...
        <Formik
          initialValues={{ 
            Daily: cp1 === null ? '' : cp1.Daily !== undefined ? cp1.Daily : Daily === undefined ? '' : Daily,
            Weekly: cp1 === null ? '': cp1.Weekly !== undefined ? cp1.Weekly : Weekly === undefined ? '' : Weekly,
            Monthly: cp1 === null ? '' : cp1.Monthly !== undefined ? cp1.Monthly : Monthly === undefined ? '' : Monthly,
            Misc: cp1 === null ? '' : cp1.Misc !== undefined ? cp1.Misc : Misc === undefined ? '' : Misc,
          }}
          ...
          {(props) => (
            <SafeAreaView style={styles.modalContent}>
              <View style={styles.header}>
                ...
                <Text style={styles.headerText}> Edit Checkpoint 1 </Text>
