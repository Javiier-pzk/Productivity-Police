...
export default function EditHabitsForm({
  item,
  closeEditModal,
  handleEditHabit,
}) {
  const [dateTime, setDateTime] = useState(
    moment(item.DateTimeFormatted, "MMMM Do YYYY, h:mm a").toDate()
  );
  const [switchOn, setSwtichOn] = useState(item.ReceiveNotif);
            ...
            <SafeAreaView style={styles.modalContent}>
              ...
              <ScrollView style={styles.scrollView}>
                ...
                <Text style={globalStyles.bodyText}>
                  {" "}
                  Enter repetition count (Eg. 4 times a day):{" "}
                </Text>
                ...
                <View style={styles.switch}>
                  ...
                  <Switch
                    style={{ marginLeft: 60 }}
                    value={switchOn}
                    onValueChange={() => setSwtichOn(!switchOn)}
                    color="#fa5d5d"
                  />
                </View>
                ...
                {switchOn && (
                  <View style={{ marginTop: 20 }}>
                    <Text style={globalStyles.bodyText}>
                      {" "}
                      Edit/set a time to receive a daily reminder:{" "}
                    </Text>
                    <DateTimePicker
