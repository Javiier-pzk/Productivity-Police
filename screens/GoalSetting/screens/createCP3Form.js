  ...
  return (
    <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
      <View style={globalStyles.container}>
        ...
        <Formik
          initialValues={{ 
            Daily: cp3.Daily === undefined ? "" : cp3.Daily ,
            Weekly: cp3.Weekly === undefined ? "" : cp3.Weekly,
            Monthly: cp3.Monthly === undefined ? "" : cp3.Monthly, 
            Misc: cp3.Misc === undefined ? "" : cp3.Misc 
          }}
          ...
          {(props) => (
            <SafeAreaView style={styles.modalContent}>
              <View style={styles.header}>
                ...
                <Text style={styles.headerText}> Checkpoint 3 </Text>
