  ...
  return (
    <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
      <View style={globalStyles.container}>
        ...
        <Formik
          initialValues={{ 
            Daily: cp2.Daily === undefined ? "" : cp2.Daily ,
            Weekly: cp2.Weekly === undefined ? "" : cp2.Weekly,
            Monthly: cp2.Monthly === undefined ? "" : cp2.Monthly, 
            Misc: cp2.Misc === undefined ? "" : cp2.Misc 
          }}
          ...
          {(props) => (
            <SafeAreaView style={styles.modalContent}>
              <View style={styles.header}>
                ...
                <Text style={styles.headerText}> Checkpoint 2 </Text>
